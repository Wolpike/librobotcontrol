...
__far volatile char C_INTC[0x1504] __attribute__((cregister("PRU_INTC", far), peripheral));
__far volatile char C_IEP[0x31c]   __attribute__((cregister("PRU_IEP",  far), peripheral)); /* PRUIEP */
__far volatile char C_CFG[0x44]    __attribute__((cregister("PRU_CFG",  far), peripheral)); /* PRUCFG */

#define PRUCFG(_reg) \
	(*(volatile u32 *)((char *)C_CFG + (_reg)))
